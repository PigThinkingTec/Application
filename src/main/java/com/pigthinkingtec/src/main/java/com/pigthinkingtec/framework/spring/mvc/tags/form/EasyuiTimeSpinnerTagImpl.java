...
public class EasyuiTimeSpinnerTagImpl extends InputTag {

    @SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(EasyuiTimeSpinnerTagImpl.class);
    ...
    private void prepare() throws JspException {    	
    	...
    	setCssClass(StringUtil.build(getCssClass(), " ", "easyui-timespinner text ime_mode_off"));
    	setCssErrorClass(StringUtil.build(getCssErrorClass(), " ", "easyui-timespinner text_error ime_mode_off")); 
