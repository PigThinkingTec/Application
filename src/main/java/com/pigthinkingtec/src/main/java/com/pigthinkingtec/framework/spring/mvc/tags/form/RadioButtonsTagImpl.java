...
/**
 * SpringのRadioButtonsTagを継承したクラス
 * 
 * @author yizhou
 */
@SuppressWarnings("serial")
public class RadioButtonsTagImpl extends RadioButtonsTag {
	
	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(RadioButtonsTagImpl.class);
